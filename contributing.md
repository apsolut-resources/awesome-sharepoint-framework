...
- Submitted open source apps should have an English readme, screenshot of the app in the readme.
...
- Don't mention `SharePoint Framework` in the description as it's implied.
